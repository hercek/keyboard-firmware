...
#define storage_read_lufa_stream_sram(buffer, length)       Endpoint_Read_Control_Stream_LE(buffer, length)
...
#define storage_write_lufa_stream_sram(buffer, length)       Endpoint_Write_Control_Stream_LE(buffer, length)
