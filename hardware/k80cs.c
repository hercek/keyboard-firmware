...
const hid_keycode logical_to_hid_map_default[NUM_LOGICAL_KEYS] STORAGE(CONSTANT_STORAGE) = {
    ...
    // LHS extra keys
	HID_KEYBOARD_SC_F11,							   //	LOGICAL_KEY_LCOL1_1, *** // outer column (top)
	HID_KEYBOARD_SC_TAB, 							   //	LOGICAL_KEY_LCOL1_2,
	HID_KEYBOARD_SC_ESCAPE,							   //	LOGICAL_KEY_LCOL1_3,
	HID_KEYBOARD_SC_DELETE,							   //	LOGICAL_KEY_LCOL1_4,
	HID_KEYBOARD_SC_MUTE,							   //	LOGICAL_KEY_LROW2, *** // bottom row (outer)
	HID_KEYBOARD_SC_NON_US_BACKSLASH_AND_PIPE,		   //	LOGICAL_KEY_LROW3,
	HID_KEYBOARD_SC_LEFT_ARROW,						   //	LOGICAL_KEY_LROW4,
	HID_KEYBOARD_SC_RIGHT_ARROW,					   //	LOGICAL_KEY_LROW5,
	HID_KEYBOARD_SC_PRINT_SCREEN,					   //	LOGICAL_KEY_LCOL2_1, // inner column (top)
	...
	// Right hand extra keys
	HID_KEYBOARD_SC_F12,							   //	LOGICAL_KEY_RCOL1_1, *** // outer column (top)
	SPECIAL_HID_KEY_MOUSE_BTN1,						   //	LOGICAL_KEY_RCOL1_2, ###
	SPECIAL_HID_KEY_MOUSE_BTN2,						   //	LOGICAL_KEY_RCOL1_3, ###
	SPECIAL_HID_KEY_MOUSE_BTN3,						   //	LOGICAL_KEY_RCOL1_4, ###
	HID_KEYBOARD_SC_ENTER,							   //	LOGICAL_KEY_RROW2, *** // bottom row (outer)
	HID_KEYBOARD_SC_KEYPAD_DOT_AND_DELETE, 			   //	LOGICAL_KEY_RROW3, ***
	HID_KEYBOARD_SC_UP_ARROW,						   //	LOGICAL_KEY_RROW4,
	HID_KEYBOARD_SC_DOWN_ARROW,						   //	LOGICAL_KEY_RROW5,
	HID_KEYBOARD_SC_PAUSE,							   //	LOGICAL_KEY_RCOL2_1, *** // inner column
