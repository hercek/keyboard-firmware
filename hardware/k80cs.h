...
//80 physical keys, 78 of which (all but layer/program control) have a separate keypad layer mapping
#define NUM_LOGICAL_KEYS (KEYPAD_LAYER_SIZE * 2)
...
#define LEDMASK_PROGRAMMING_DST  0x40
#define LEDMASK_MACRO_TRIGGER    0x60
#define LEDMASK_MACRO_RECORD     0x80
#define LEDMASK_MACROS_ENABLED   0xA0
#define LEDMASK_PROGRAMS_ENABLED 0xC0
