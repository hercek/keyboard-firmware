...
const logical_keycode matrix_to_logical_map[MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
	...
	/*PB0 (7) + GPA0*/ {LOGICAL_KEY_RCOL2_1,   LOGICAL_KEY_RCOL2_2, NO_KEY,                LOGICAL_KEY_RCOL2_3, NO_KEY,            LOGICAL_KEY_R_ALT,  LOGICAL_KEY_LCOL1_1, LOGICAL_KEY_LCOL1_2, LOGICAL_KEY_LCOL1_3, LOGICAL_KEY_LCOL1_4, LOGICAL_KEY_LROW1, NO_KEY},
	...
	/*PC6 (D) + GPA6*/ {LOGICAL_KEY_RCOL1_1,   LOGICAL_KEY_RCOL1_2, LOGICAL_KEY_RCOL1_3,   LOGICAL_KEY_RCOL1_4, LOGICAL_KEY_RROW1, NO_KEY,             LOGICAL_KEY_LCOL2_1, LOGICAL_KEY_LCOL2_2, NO_KEY,        LOGICAL_KEY_LCOL2_3, NO_KEY,            LOGICAL_KEY_L_ALT}
};
#undef KEY_NONE
...
const hid_keycode logical_to_hid_map_default[NUM_LOGICAL_KEYS] PROGMEM = {
	...
	SPECIAL_HID_KEY_LAYER_LOCK,						   //	LOGICAL_KEY_LCOL2_1, // inner column
	SPECIAL_HID_KEY_KEYPAD_SHIFT,					   //	LOGICAL_KEY_LCOL2_2,
	NO_KEY,											   //	LOGICAL_KEY_LCOL2_3,
	...
	SPECIAL_HID_KEY_PROGRAM, 						   //	LOGICAL_KEY_RCOL2_1, // inner column
	SPECIAL_HID_KEY_KEYPAD_SHIFT,					   //	LOGICAL_KEY_RCOL2_2,
	NO_KEY, 										   //	LOGICAL_KEY_RCOL2_3,
	// Left hand thumbpad
	...
	SPECIAL_HID_KEY_LAYER_LOCK,						   //	LOGICAL_KEY_KP_LCOL2_1, // inner column
